    ...
    public static class SqlHelper
    {
        ...
        private static DataTable ToDataTable(IEnumerable instances, Type type, string typeName, MemberTypes memberTypes, DataTable table)
        {
            if (instances is IEnumerable<IDictionary<string, object>>)
                return ToDataTable((IEnumerable<IDictionary<string, object>>)instances, false, typeName, table, null, null);
        ...
        {
            return ToEnumerable<T>(view, () => new T(), getValue).ToList<T>();
        }

        public static List<T> ToList<T>(this DataView view, Func<T> instanceHandler, ValueHandler getValue = null)
        {
            return ToEnumerable<T>(view, instanceHandler, getValue).ToList<T>();
        }
        ...
        {
            IEnumerable<IDictionary<string, object>> values = ToProperties(objs, getValue, columnNames);
        ...
        public static DataTable ToDataTable(this IEnumerable<dynamic> objs, bool toEmptyDataTable = false, string typeName = null, DataTable table = null, ValueHandler getValue = null, params string[] columnNames) { if (objs is IEnumerable<IDictionary<string, object>>) return ToDataTable((IEnumerable<IDictionary<string, object>>)objs, toEmptyDataTable, typeName, table, getValue, columnNames); else return ToDataTable((IEnumerable<IDictionary<string, object>>)objs, typeName: typeName, table: table); }
        public static DataTable ToDataTable(this IEnumerable<Dictionary<string, object>> objs, bool toEmptyDataTable = false, string typeName = null, DataTable table = null, ValueHandler getValue = null, params string[] columnNames) { return ToDataTable((IEnumerable<IDictionary<string, object>>)objs, toEmptyDataTable, typeName, table, getValue, columnNames); }
